...
function PipePair:init(y)
    ...
    local new_gap_height = GAP_HEIGHT + math.random(-GAP_VARIANCE, GAP_VARIANCE)
    print(string.format("DEBUG: New gap height=%d", new_gap_height))
    self.pipes = {
        ['upper'] = Pipe('top', self.y),
        ['lower'] = Pipe('bottom', self.y + PIPE_HEIGHT + new_gap_height)
    }
